...
def main():
    ...
    print(f"Nice to meet you {name}. what would you like to do?")
    print('\n')
                            ...
                            if short_code == 'ac':
                                    ...
                                    while True:
                                        ...
                                        if short_code == 'ty':
                                            ...
                                            passwords = ("neurosurge0n", "p@$$w0rd", "++NAME++", "IamLegend")
                                    ...
                                    if dis_all_accounts():
                                            print("Here are your accounts and their credentials")
                                            print('\n')
                                            ...
                                            print('\n')
                                            print("No saved accounts at the moment")
                                            print('\n')

                            elif short_code == 'fc':

                                    print("type name of account you would like to access")
                                    ...
                                    print("You were expected to use the shortcodes")

                    else:
                        print('-'*50)
                        print(f"Username or Password is incorrect.Please try again")
                        print('-'*50)

            elif short_code == "ex":
                    print("Done.Be assured that your credentials are in full protection")
                    break
